...
export default class Step4CheckPacketAvailability extends AbstractStep {
    ...
    checkAvailability = async () => {
        ...
        const potentialAssignments = await Api.get(`/bookings/${data.creationId}/potentialPacketAssignments`)
    ...
    assignPackets = async () => {
        ...
        if (potentialAssignments.length > 0) {
            ...
            const updated = await Api.post(`/bookings/${data.creationId}/packetAssignments`, potentialAssignments)
        ...
        if (busy || !potentialAssignments) {
            ...
            return (
                <div className="form-error">
                    ...
                    <p>You may want to <Link to="/packetAssignments" target="_blank">review the list of packets already assigned</Link> and see if you can think of a way to make it work even though our software (which isn&rsquo;t perfect!) couldn&rsquo;t. If so, please write to us at <Mailto />.</p>
